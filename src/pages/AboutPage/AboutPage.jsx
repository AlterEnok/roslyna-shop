            ...
            <section className="about-partners">
                ...
                <div className="partners-text">
                    ...
                    <div className="partners-box">
                        ...
                        <p>
                            Відкрийте Регіональне Представництво у своєму місті і заробляйте ще більше разом із компанією
                            «Рослина Карпат».
                        </p>
                        <p>
                            Компанія надає активним партнерам унікальну можливість — відкрити власне Регіональне Представництво
                            у своєму місті чи селищі та отримувати додатковий стабільний дохід від його товарообігу.
                        </p>
                        <p>
                            Це — ваш офіційний бізнес під крилом великого українського бренду, який працює на ринку з 2003 року 💚
                        </p>
                        <p>🌿 <strong>Що ви отримуєте:</strong></p>
                        <ul>
                            <li><strong>Офіційний статус:</strong> ваш пункт продажу буде опублікований на сайті компанії.</li>
                            <li><strong>Потік нових клієнтів:</strong> люди з вашого регіону приходитимуть саме до вас.</li>
                            <li><strong>Розвиток особистого бізнесу:</strong> ви керуєте своїм представництвом і командою.</li>
                            <li><strong>Підтримку від компанії:</strong> навчання, реклама, промоматеріали та консультації.</li>
                            <li><strong>Додатковий прибуток:</strong> бонус до 90% від обороту представництва 💸</li>
                        </ul>
                    </div>
                </div>
            </section>
